...
public class Box : MonoBehaviour
{
    ...
    private bool _onGround => Physics.Raycast(transform.position + new Vector3 (0, 0.1f, 0), Vector3.down, 0.2f, _groundLayer);   //地面確認
    ...
    void Update()
    {
        ...
        Debug.DrawRay(transform.position + new Vector3(0, 0.1f, 0), Vector3.down * 0.2f, _onGround ? Color.red : Color.green);
    }
